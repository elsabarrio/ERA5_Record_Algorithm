---
title: "2.1 Setting stations records"
format: html
editor: visual
---
...
tx.mat <- read.csv("../../Data/tx_data/Tx_mat.csv", header = TRUE)
...
if (!file.exists(file.path(outdir,"record_matrix.csv"))) {
  # Save the record matrix
  write.csv(x = record.df,
            file = file.path(outdir,"record_matrix.csv"),
            row.names = FALSE)
}
