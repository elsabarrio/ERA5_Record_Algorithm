...
Set the records from maximum temperature series based on the day within year
...
# Reshape volume
record.df <- as.data.frame(array(aperm(itx3d, c(2,1,3)), dim = c(length(dates.idx),SS)))
