...
# Set training set
idx.train <- which(global.df$t <= 51 & global.df$t > 1)
...
if (!file.exists(model_file)) {
   ...
   toc <- Sys.time()
   cat("M1: ")
   print(toc-tic) # Time difference of 31.87176 mins
...
if(!file.exists(model_file)) {
  ...
  cat("M2: ")
  print(toc-tic)
  # Time difference of 5.773433 hours
...
if (!file.exists(model_file)) {
  ...
  cat("M3: ")
  print(toc-tic)
  # Time difference of 4.872496 hours
...
if(!file.exists(model_file)) {
  ...
  cat("M4: ")
  print(toc-tic)
  # Time difference of 1.826904 hours
...
if(!file.exists(model_file)) {
  ...
  cat("M5: ")
  print(toc-tic)
  # Time difference of 1.379474 days
