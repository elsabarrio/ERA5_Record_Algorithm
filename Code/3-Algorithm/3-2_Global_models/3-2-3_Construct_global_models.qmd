...
if (!file.exists(model_file)) {
   ...
   toc <- Sys.time()
   cat("M1: ")
   print(toc-tic) # Time difference of 6.29911 mins
...
if(!file.exists(model_file)) {
  ...
  frm3 <- readRDS('C:/Users/elsac/Documents/ERA5_Record_Algorithm/Results/final_models/m3.rds')
  ...
  # Run step
  tic <- Sys.time()
  m5 <- stepAIC(object = m3,
                direction = "both",
                scope = list(lower = m3, upper = full.m5),
                k = 10.82757)
  toc <- Sys.time()
  cat("M5: ")
  print(toc-tic)
...
if(!file.exists(model_file)) {
  ...
  frm4 <- readRDS('C:/Users/elsac/Documents/ERA5_Record_Algorithm/Results/final_models/m4.rds')
  ...
  # Run step
  tic <- Sys.time()
  m5 <- stepAIC(object = m4,
                direction = "both",
                scope = list(lower = m4, upper = full.m5),
                k = 10.82757)
  toc <- Sys.time()
  cat("M5: ")
  print(toc-tic)
