---
title: "3-2-1 M1_variable_selection"
format: html
editor: visual
---
...
for (original_col in originals) {
  ...
  z.mat[[poly_col]] <-  rowSums(cbind(z.mat[[original_col]],
                                      z.mat[[poly_col]]),
                                na.rm = TRUE)
  
  # Keep the NAs
  if(any(z.mat[[poly_col]]==0)) z.mat[[poly_col]][which(z.mat[[poly_col]]==0)] <- NA
...
write.csv(x = z.mat,
          file = file.path(save.dir, "zvalues_1single_df.csv" ),
          row.names = F)
...
folder_path <- "../../../Results/final_models"
